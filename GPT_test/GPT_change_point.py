...
pathlib.Path("/Users/joytsai/Downloads/20230113/3-2-1162bp-150mMKCl-25nMRec10-rt/BMx_fixing_Pelt").mkdir(parents=True, exist_ok=False)

# Create step.txt
step_file = open("/Users/joytsai/Downloads/20230113/3-2-1162bp-150mMKCl-25nMRec10-rt/BMx_fixing_Pelt/step.txt", "w")
...
for bead in range(df.shape[1] - 1):
    ...
    plt.savefig(f"/Users/joytsai/Downloads/20230113/3-2-1162bp-150mMKCl-25nMRec10-rt/BMx_fixing_Pelt/BMx_fixing_{bead}.png"
                , dpi=300)
    plt.close()
